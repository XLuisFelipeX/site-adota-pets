...
Class Rotas{
	...
	static function pag_CadastrarAnimal(){
		return  self::get_SiteHOME(). '/cadastraranimal';
	}

	static function pag_Anuncie(){
		return  self::get_SiteHOME(). '/anuncie';
	}
    ...
    static function pag_QuemSomos(){
		return  self::get_SiteHOME(). '/quemsomos';
	}
